...
function group_animation() {
    ...
    console.log(`${currentSegment} point로 향함`);
    console.log(`거리 : ${trainGroup.position.distanceTo(points[currentSegment])}`);
    ...
    if(currentSegment === 0){
        camera.position.set(trainGroup.position.x, trainGroup.position.y, trainGroup.position.z+10);
